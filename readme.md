...
* Automatic cleanup of the oldest Pinecone index when the free-tier limit is reached
* Streamlit-based UI
...
* streamlit\_ui.py -> Streamlit frontend
...
* Start frontend:		streamlit run streamlit\_ui.py
